...
> [Τράπεζα Θεμάτων 25918][trapeza22_25918]
...
- Συντακτικά & Λογικά λάθη
  ...
  - [Τράπεζα Θεμάτων 25893][trapeza22_25893]
  - [Τράπεζα Θεμάτων 25919][trapeza22_25919]
---
layout: true
...
>   - Οι χαρακτήρες πρέπει υποχρεωτικά να βρίσκονται μέσα σε απλά εισαγωγικά, `' '` ή διπλά εισαγωγικά `" "`.
...
```
[Τράπεζα Θεμάτων 25941 - Διάβασε μέχρις ότου να δοθεί το ΤΕΛΟΣ] [trapeza22_25941]
---
...
- Να διαβάζει τις εισπράξεις 10 εταιρειών, για το τρέχον έτος.
- Να υπολογίζει και να εμφανίζει το μέσο όρο των εισπράξεων.
- Να υπολογίζει και να εμφανίζει το ποσοστό των εταιρείων με έσοδα περισσότερα από €200.000.
...
- Να διαβάζει τα περιστατικά COVID-19 των 27 ευρωπαικών χωρών, για τον τρέχον μήνα.
- Να υπολογίζει και να εμφανίζει το μέσο όρο των περιστατικών.
- Να υπολογίζει και να εμφανίζει το πλήθος των χωρών με περιστατικά κάτω από 10.000.
...
>
> … ας σημειωθεί ωστόσο ότι υπάρχουν κάποιες δεσμεύσεις μεταξύ των τιμών από, μέχρι και βήμα. Έτσι <u>το βήμα δεν μπορεί να είναι μηδέν, γιατί τότε ο βρόχος εκτελείται επ’ άπειρον</u>. <u>Είναι δυνατόν όμως το βήμα να έχει αρνητική τιμή, αρκεί η τιμή `ΑΠΟ` να είναι μεγαλύτερη από την τιμή `ΜΕΧΡΙ`</u>, όπως για παράδειγμα στην επόμενη εντολή: `ΓΙΑ k ΑΠΟ 100 ΜΕΧΡΙ 0 ΜΕ_ΒΗΜΑ -1`
>
...
Για ι από 1 μέχρι 10
  Εμφάνισε 2*(ι - 1) + (ι - 1) + 1                  ! 1,4,7,10,13,16,19,22,25,28
Τέλος_επανάληψης

Για ι από 1 μέχρι 10
  Εμφάνισε 60 - (ι - 1)*6                          ! 60,54,48,42,36,30,24,18,12,6
Τέλος_επανάληψης

Για ι από 1 μέχρι 10
  Αν ι mod 2 = 1 τότε                                      ! 2,9,4,7,6,5,8,3,10,1
    Εμφάνισε ι + 1
  αλλιώς
    Εμφάνισε 10 - (ι - 1) 
  Τέλος_αν
...
Για ι από 1 μέχρι 10
  Εμφάνισε 2*ι, 40 - 4*ι  ! 2,36,4,32,6,28,8,24,10,20,12,16,14,12,16,8,18,4,20,0
Τέλος_επανάληψης
```
---
...
> Στην εντολή αυτή χρησιμοποιείται μια `<μεταβλητή>` στην οποία αρχικά καταχωρίζεται η `<αρχική-τιμή>`. Η τιμή που παίρνει η `<μεταβλητή>` συγκρίνεται με τη `<τελική-τιμή>` και εφόσον είναι μικρότερη ή ίση από αυτή, τότε εκτελούνται οι εντολές που βρίσκονται στον βρόχο.
>
> Στη συνέχεια, η μεταβλητή αυξάνεται κατά την τιμή χ που ορίζει το `ΒΗΜΑ`. Αν η νέα τιμή είναι μικρότερη ή ίση της τελικής, τότε ο βρόχος εκτελείται ξανά. Η διαδικασία επαναλαμβάνεται μέχρι η `<μεταβλητή>` να πάρει τιμή μεγαλύτερη από την `<τελική-τιμή>` αλλιώς το πρόγραμμα συνεχίζει με την εντολή μετά το «`ΤΕΛΟΣ_ΕΠΑΝΑΛΗΨΗΣ`».
>
...
> 1. **`Βήμα > 0`**: τότε πρέπει να ισχύει **αρχική-τιμή ≤ τελική-τιμή** για να εκτελεστεί τουλάχιστον μία φορά ο βρόχος.
> 1. **`Βήμα < 0`**: τότε πρέπει να ισχύει **αρχική-τιμή ≥ τελική-τιμή** για να εκτελεστεί τουλάχιστον μία φορά ο βρόχος.
...
.footnote[
  [Τράπεζα Θεμάτων 24647:Μετατροπή όσο->μεχρις\_οτου][trapeza22_24647]<br>
  [Τράπεζα Θεμάτων 26154:Μετατροπή όσο->μεχρις\_οτου][trapeza22_26154]
]
...
> [Τράπεζα Θεμάτων 25933][https://www.dropbox.com/s/m3z490pa9j12h02/25933.pdf?dl=0]
...
Από την άλλη, σε μια Διαδικασία μπορώ να τροποποιήσω τις τιμές των πραγματικών παραμέτρων, με τις οποίες κλήθηκε η Διαδικασία, τροποποιώντας τις αντίστοιχες τυπικές παραμέτρους. Όταν μία διαδικασία τερματίζει, οι τιμές των τυπικών παραμέτρων αντιγράφονται πίσω στις αντίσοιχες πραγματικές.
...
[trapeza22_24647]: https://www.dropbox.com/s/8ez0qj5wu4rhiqf/24647.pdf?dl=0
[trapeza22_25893]: https://www.dropbox.com/s/8si7xts5i4n4ijp/25893.pdf?dl=0
[trapeza22_25918]: https://www.dropbox.com/s/hso1jrw9tbydx08/25918.pdf?dl=0
[trapeza22_25919]: https://www.dropbox.com/s/e3lzw61dy813956/25919.pdf?dl=0
[trapeza22_25941]: https://www.dropbox.com/s/ni4qzt9iinmpoxu/25941.pdf?dl=0
[trapeza22_25947]: https://www.dropbox.com/s/th9bg9sl57o1miy/25947.pdf?dl=0
[trapeza22_26154]: https://www.dropbox.com/s/to3qhxf8wwg22yo/26154.pdf?dl=0
